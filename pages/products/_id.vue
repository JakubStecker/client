                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="mt-0 lg:mt-20 flex flex-col">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between">
                            ...
                            <button class="bg-cinnabar-500 text-white-linen-500 rounded-full h-16 px-5 font-bold flex justify-center items-center" @click="() => {addItem({id: product.id, quantity: quantity}); finalPriceMethod({ing: product.selectedIngredients, id: product.id, size: product.size})}">
